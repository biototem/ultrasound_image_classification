...
if __name__ == "__main__":
    ...
    label0_arr = []
    label0_path = conf.get("DEFAULT", "ULTRASONIC_LABEL0")
#    label0_path = './benign/ultrasonic'
    ...
    label1_arr = []
#    label1_path = './malignant/ultrasonic'
    label1_path = conf.get("DEFAULT", "ULTRASONIC_LABEL1")
    ...
    file_path = conf.get("DEFAULT", "ULTRASONIC_CHECKPOINT_PATH")
